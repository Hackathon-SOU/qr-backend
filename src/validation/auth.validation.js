...
const resetPasswordAdminSchema = {
  body: joi.object().keys({
    confirmPassword: joi.string().min(3).trim(true).required().messages({
      "string.base": `Password should be a type of 'string'`,
      "string.empty": `Password cannot be an empty field`,
      "string.min": `Password cannot be less than 3 charachters`,
      "any.required": `Password is a required field`,
    }),
    updatePassword: joi.string().min(3).trim(true).required().messages({
      "string.base": `Password should be a type of 'string'`,
      "string.empty": `Password cannot be an empty field`,
      "string.min": `Password cannot be less than 3 charachters`,
      "any.required": `Password is a required field`,
